                                            ...
                                            cy.wrap($match)
                                                ...
                                                .then((href) => {
                                                    if (href.match(/base\.css/)) {
                                                        ...
                                                        .its('body') // NB the response body, not the body of your page
                                                        .then(content => {
                                                            cy.writeFile(`base_${url}.css`, content)
                                                        })
                                                    }
                                                })
                                        }
                        ...
                        cy.request(current_url)
                            ...
                            .then(content => {
                                ...
                                srcs.forEach(src =>
                                    ...
                                    .its('body') // NB the response body, not the body of your page
                                    .then(content => {
                                        const regex = /appid=[a-z0-9]+/;
                                        const appid_index = content.search(regex);
                                        if (appid_index !== -1) {
                                            const appid = content.substring(appid_index, appid_index + 38).split("=")[1];
                                            cy.writeFile('cypress/downloads/api.txt', `${appid} - ${url}\n`, { flag: 'a+' })
                                        }
